...
$notify_url = ""; //TODO: get definition from config
$return_url = ""; //TODO: get definition from config
...
try {
    ...
    if ($data['return_code']=='FAIL') {
        ...
        if ($data['api_out_trade_no'] != $out_trade_no) {
            $errmsg = 'Data mismatch: api_out_trade_no ' . $data['api_out_trade_no'] . ' does not match original out_trade_no ' . $out_trade_no;
            error_log($errmsg);
            //TDDO: return 503
        }
